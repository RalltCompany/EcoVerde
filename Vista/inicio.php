                    ...
                    <div class="our-link">
                        <ul>
                            ...
                            if(isset($_SESSION['CI'])){
                                echo $_SESSION['CI'];
                               echo  "<li><a href=#><i class=fa fa-user s_color></i> Bienvenido/a</a></li>";
                               echo  "<li><a href=Controlador/logout.php><i class=fa fa-user s_color></i> Cerrar Sesion</a></li>";
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="Vista/about.html">Sobre nosotros</a></li>
                        <li class="dropdown">
